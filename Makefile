...
SOURCES = \
	__init__.py \
	jd_boundary_uploader.py jd_boundary_uploader_dockwidget.py

PLUGINNAME = jd_boundary_uploader

PY_FILES = \
	__init__.py \
	jd_boundary_uploader.py jd_boundary_uploader_dockwidget.py

UI_FILES = jd_boundary_uploader_dockwidget_base.ui
...
QGISDIR=C:\Users\Frédéric Landry\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
